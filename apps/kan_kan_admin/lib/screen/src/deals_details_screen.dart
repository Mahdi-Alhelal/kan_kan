                                  ...
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      detailCubit.quantityController.text =
                                          detailCubit.deal.quantity.toString();
                                      ...
                                      detailCubit.dealTypeController.text =
                                          detailCubit.deal.categoryId
                                              .toString();
                                      detailCubit.dealDurationController.text =
                                      ...
                                      detailCubit.priceController.text =
                                          detailCubit.deal.salePrice.toString();
                                      detailCubit.costController.text =
                                          detailCubit.deal.costPrice.toString();
                                      detailCubit.deliveryCostController.text =
                                      ...
                                      detailCubit
                                              .estimatedTimeToController.text =
                                          detailCubit
